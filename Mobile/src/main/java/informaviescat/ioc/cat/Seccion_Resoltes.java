...
public class Seccion_Resoltes extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Activity activity_de_origen = Seccion_Resoltes.this;
    String temp_userId = " ";

    private IncidentAdapter incidentAdapter;

    private int incidentType_seleccionado = 4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_resoltes);
        ...
        serverController.getAllIncidencias(String.valueOf(id), String.valueOf(rolId), session_id, new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                    if (response.isSuccessful()) {
                        ...
                        Log.d("Debug Vicent", "Tancades Activity: respuesta de get all cifrada: " + json_recibido_cifrado);
                        ...
                        Log.d("Debug Vicent", "Tancades Activity: respuesta de get all descifrada: " + responseBody);
                        ...
                        try {
                            ...
                            runOnUiThread(() -> {
                                ...
                                recyclerView.setLayoutManager(new LinearLayoutManager(Seccion_Resoltes.this));
                        ...
                        runOnUiThread(() -> {
                            Toast.makeText(Seccion_Resoltes.this, "Error al descargar las incidencias", Toast.LENGTH_LONG).show();
                        });
                    }
                }
