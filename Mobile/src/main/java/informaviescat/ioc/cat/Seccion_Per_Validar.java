...
public class Seccion_Per_Validar extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private int incidentType_seleccionado = 1;
        ...
        serverController.getAllIncidencias(String.valueOf(id), String.valueOf(rolId), session_id, new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    Log.d("Debug Vicent", "Per Validar Activity: respuesta de get all cifrada: " + json_recibido_cifrado);
                    ...
                    Log.d("Debug Vicent", "Per Validar Activity: respuesta de get all descifrada: " + responseBody);
                    ...
                    try {
                        ...
                        Log.d("Debug Vicent", "Longitud de incidentList es " + incidentList.size());

                        //Actualizar el RecyclerView después de obtener los datos
                        runOnUiThread(() -> {
                            RecyclerView recyclerView = findViewById(R.id.recyclerView);
                            recyclerView.setLayoutManager(new LinearLayoutManager(Seccion_Per_Validar.this));
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(Seccion_Per_Validar.this, "Error al descargar las incidencias", Toast.LENGTH_LONG).show();
                    });
                }
            }
