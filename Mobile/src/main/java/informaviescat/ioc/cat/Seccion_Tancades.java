...
public class Seccion_Tancades extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    Activity activity_de_origen = Seccion_Tancades.this;
    String temp_userId = " ";

    private IncidentAdapter incidentAdapter;

    private int incidentType_seleccionado = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seccion_tancades);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        runOnUiThread(() -> {
                            ...
                            recyclerView.setLayoutManager(new LinearLayoutManager(Seccion_Tancades.this));
                    ...
                    runOnUiThread(() -> {
                        Toast.makeText(Seccion_Tancades.this, "Error al descargar las incidencias", Toast.LENGTH_LONG).show();
                    });
                }
            }
